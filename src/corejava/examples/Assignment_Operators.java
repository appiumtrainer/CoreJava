...
public class Assignment_Operators {
	...
	static String name = "Google"; // name variable gets the value Google
	static boolean isGood = false; // isGood variable gets the value true
	...
	public static void main(String[] args) {
		...
		//speed = "Google1234"; //String can not be assign to integer
		name = "10"; // Integer can not be assign to String
		//isGood = "Google" // String can not be assign to Boolean
		}
	}
